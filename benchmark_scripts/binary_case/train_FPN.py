...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f'training_fpn_binary_crop{TARGET_CROP}.log'),
...
for epoch in epoch_pbar:
    ...
    if val_f1 > best_val_f1:
        best_val_f1 = val_f1
        torch.save(model.state_dict(), f'best_fpn_model_binary_crop{TARGET_CROP}.pth')
...
model.load_state_dict(torch.load(f'best_fpn_model_binary_crop{TARGET_CROP}.pth'))
