...
# Model setup
logger.info('Initializing PSPNet model for binary classification')
model = smp.PSPNet(
...
# Model is now properly configured with in_channels=18 and upsampling=4
...
for epoch in epoch_pbar:
    ...
    if val_f1 > best_val_f1:
        best_val_f1 = val_f1
        torch.save(model.state_dict(), f'best_pspnet_model_binary_crop{TARGET_CROP}.pth')
...
model.load_state_dict(torch.load(f'best_pspnet_model_binary_crop{TARGET_CROP}.pth'))
