...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f'training_upernet_binary_crop{TARGET_CROP}.log'),
...
for epoch in epoch_pbar:
    ...
    if val_f1 > best_val_f1:
        best_val_f1 = val_f1
        torch.save(model.state_dict(), f'best_upernet_model_binary_crop{TARGET_CROP}.pth')
...
model.load_state_dict(torch.load(f'best_upernet_model_binary_crop{TARGET_CROP}.pth'))
